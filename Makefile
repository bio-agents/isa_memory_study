.PHONY: clean data figures lint requirements
...
requirements: test_environment
	pip install -U pip setupagents wheel
...
figures: requirements data
	$(PYTHON_INTERPRETER) src/visualization/make_figures.py $(PROJECT_DIR)/data/processed/memory_footprint_by_category.csv $(PROJECT_DIR)/reports/figures/
...
clean:
	...
	find ./data/interim -type d -name "MTBLS*" | xargs rm -r
